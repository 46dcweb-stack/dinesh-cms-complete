...
export default function ManifestoTeaser({ 
  eyebrow = "The Core Conviction",
  quote = "I believe the best companies are built not just on ideas, but on conviction."
}: {
  eyebrow?: string;
  quote?: string;
}) {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-32 px-6 relative overflow-hidden bg-brand-dark"
    >
      {/* Background Image */}
        ...
        <div className="glass-card p-12 md:p-20 relative overflow-hidden border-brand-primary/10">
          ...
          <div
            className="
              ...
              w-[600px] h-[600px]
              bg-[radial-gradient(ellipse_at_center,rgba(255,90,0,0.1)_0%,transparent_70%)]
              rounded-full
          ...
          >
            ...
            <Link
              href="/manifesto"
              className="btn-premium group inline-flex liquid-fill"
            >
              Read My Manifesto
