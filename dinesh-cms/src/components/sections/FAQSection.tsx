...
const faqs = [
  {
    ...
    answer:
      "Currently, my primary focus is on global logistics, sovereign data infrastructure, and biophilic technology. These represent the key pillars of resilient growth for the next decade.",
  },
  {
    question: "How do you approach venture building?",
    answer:
      "We use a 'resilient systems' framework. Instead of building for quick exits, we build for structural integrity, long-term scalability, and the ability to thrive under systemic pressure.",
  },
  {
    question: "Where are your global operations based?",
    answer:
      "FourSix46 operates across 5 global hubs, facilitating cross-border innovation and infrastructure deployment. Our decentralized approach ensures local relevance and global scale.",
  },
  {
    question: "How can I collaborate with FourSix46?",
    answer:
      "We are always looking for visionary founders, strategic investors, and domain experts. You can reach out via our contact page to start a conversation about architecture and intent.",
  },
];
...
export default function FAQSection({
  ...
  description = "Quick insights into the architecture, vision, and operations of our venture studio.",
}: FAQSectionProps) {
    ...
    <section className="py-24 md:py-32 bg-brand-dark/20 border-t border-white/5 relative">
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-12 lg:gap-24">
          ...
          {/* Left Column */}
          <div>
            <span className="text-brand-primary font-medium tracking-[0.3em] text-[10px] uppercase block mb-6 font-mono">
              {eyebrow}
            </span>
